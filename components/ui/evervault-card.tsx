...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "p-0.5 bg-transparent flex items-center justify-center h-screen w-screen relative",
        className
      )}
    >
      <div
        onMouseMove={onMouseMove}
        className="group/card rounded-none w-full h-full relative overflow-hidden bg-transparent flex items-center justify-center"
      >
        <CardPattern
          mouseX={mouseX}
          mouseY={mouseY}
